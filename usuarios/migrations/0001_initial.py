# Generated by Django 4.2.20 on 2025-06-05 19:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('musico', 'Músico'), ('empleador', 'Empleador')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ubicacion', models.CharField(max_length=100)),
                ('contacto_alternativo', models.CharField(blank=True, max_length=100)),
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
